...
function RunningQueueDispatcher () {
  ...
  this.executeTargetScript = function (source, executeArguments) {
    ...
    ui.run(function () {
      ...
      args.executeByDispatcher = true
      if (typeof config._buddha !== 'undefined' && config._buddha !== null) {
        args.buddha = config._buddha
      }
      // AutoJs6 6.7 的 ExecutionConfig 不接受 null 或 undefined 的启动参数。
